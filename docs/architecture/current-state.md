...
| UI layer breadth (Android / iOS / Web) | Android (Qt Quick QML, M85) + Web (HTML/JS browser client, M110/M123/M124) shipped. iOS scaffold (Info.plist + CMake guard) ready for a real macOS host (PA-010). Mobile QML now covers Settings hub + Profile / Contacts / Devices / Search / Attachments / RemoteControl / Call (M120-M122). |
